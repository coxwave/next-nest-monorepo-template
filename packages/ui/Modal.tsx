  ...
  return (
    <Transition.Root show={show} as={Fragment}>
      <Dialog
        as="div"
        static
        className="fixed inset-0 z-30 overflow-y-auto px-4"
      ...
      >
        <div className="flex min-h-screen items-center justify-center pt-32 text-center sm:block sm:p-0">
          ...
          >
            <div className="relative inline-block w-full overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left align-bottom shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6 sm:align-middle">
              <div
                className={clsx({
                ...
                <button
                  ...
                  className={clsx(
                    'inline-flex w-full justify-center rounded-md border border-transparent px-4 py-2 text-base font-medium text-white shadow-sm sm:text-sm',
                    {
                      ...
                      'bg-red-500 text-white sm:ml-3 sm:w-auto': variant === 'alert',
                    },
                  )}
                  onClick={async () => {
